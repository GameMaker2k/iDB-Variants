...
if (!isset($Settings['sqldb'])) {
    echo "Sorry you can not signup yet.";
    $Error = "Yes";
    die();
}
...
@session_start();
if (strlen($_POST['AdminPasswords']) <= "3") {
    $Error = "Yes";
...
if (strlen($_POST['AdminPasswords']) >= "30") {
    $Error = "Yes";
    echo "<br />Your password is too big.";
}
if (strlen($_POST['AdminUser']) >= "20") {
    $Error = "Yes";
...
if ($Error != "Yes") {
    ...
    */
    ...
    while ($i < $grand) {
        ...
        ++$i;
    } $GuestPassword = b64e_hmac($gpass, $YourDate, $GSalt, "sha1");
