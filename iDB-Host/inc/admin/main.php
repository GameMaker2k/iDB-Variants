...
if ($_GET['act'] == "mysql" && $_GET['board'] != $Settings['root_board']) {
    redirect("location", $basedir.url_maker($exfile['index'], $Settings['file_ext'], "act=view", $Settings['qstr'], $Settings['qsep'], $prexqstr['index'], $exqstr['index'], false));
    ob_clean();
    @header("Content-Type: text/plain; charset=".$Settings['charset']);
    gzip_page($Settings['use_gzip'], $GZipEncode['Type']);
...
<?php } ?>
	...
	<option<?php if ($Settings['AdminValidate'] == false) {
	    echo " selected=\"selected\"";
	} ?> value="false">no</option>
	<option<?php if ($Settings['AdminValidate'] == true) {
	    echo " selected=\"selected\"";
...
<?php if ($_GET['board'] == $Settings['root_board']) { ?>
	...
	<option<?php if ($Settings['enable_https'] == true) {
	    echo " selected=\"selected\"";
	} ?> value="true">on</option>
	<option<?php if ($Settings['enable_https'] == false) {
	    echo " selected=\"selected\"";
...
<?php } ?>
	...
	<option<?php if ($Settings['enable_rss'] == true) {
	    echo " selected=\"selected\"";
	} ?> value="true">on</option>
	<option<?php if ($Settings['enable_rss'] == false) {
	    echo " selected=\"selected\"";
	} ?> value="false">off</option>
	</select></td>
</tr><tr style="text-align: left;">
	...
	<option<?php if ($Settings['enable_search'] == true) {
	    echo " selected=\"selected\"";
	} ?> value="true">on</option>
	<option<?php if ($Settings['enable_search'] == false) {
	    echo " selected=\"selected\"";
	} ?> value="false">off</option>
	</select></td>
</tr><tr style="text-align: left;">
...
<option<?php if ($Settings['TestReferer'] == true) {
    echo " selected=\"selected\"";
} ?> value="on">on</option>
<option<?php if ($Settings['TestReferer'] == false) {
    echo " selected=\"selected\"";
} ?> value="off">off</option>
</select></td>
</tr></table>
...
} if ($_GET['act'] == "mysql" && $_POST['update'] != "now" &&
$_GET['board'] == $Settings['root_board'] && $GroupInfo['ViewDBInfo'] == "yes") {
    require($_GET['board'].'_settings.php');
