<?php ob_start(); @set_time_limit(30); @ignore_user_abort(true); ?>
...
return $TestHour3; }
$Settings['qstr'] = "&"; $Settings['charset'] = "iso-8859-15";
...
if(!isset($_GET['file'])) { $_GET['act'] = "view"; 
	$_GET['file'] = null; }
...
if(isset($_GET['dir'])&&isset($_GET['subdir'])) {
	...
	if($_GET['dir']=="themes") {
		if($_GET['subdir']!="Gray"&&$_GET['subdir']!="iDB"&&
			...
			$_GET['subdir']!="TFBB") { $_GET['subdir'] = null; } } }
if(!isset($_GET['subdir'])) { $_GET['subdir'] = null; }
...
if($_GET['act']=="view"||
	$_GET['act']=="list") { $chdone = false;
$ftpid = ftp_connect("ftp.berlios.de");
$result = ftp_login($ftpid, "anonymous", "anonymous");
if($_GET['dir']=="etc"&&$_GET['subdir']!=null&&$chdone!=true) { $chdone = true;
ftp_chdir($ftpid,"/pub/idb/".$_GET['dir']."/".$_GET['subdir']."/"); }
if($_GET['dir']=="CPlusPlus"&&$_GET['subdir']!=null&&$chdone!=true) { $chdone = true;
ftp_chdir($ftpid,"/pub/idb/".$_GET['dir']."/".$_GET['subdir']."/"); }
if($_GET['dir']=="KolibriOS"&&$_GET['subdir']!=null&&$chdone!=true) { $chdone = true;
ftp_chdir($ftpid,"/pub/idb/".$_GET['dir']."/".$_GET['subdir']."/"); }
if($_GET['dir']=="themes"&&$_GET['subdir']!=null&&$chdone!=true) { $chdone = true;
ftp_chdir($ftpid,"/pub/idb/".$_GET['dir']."/".$_GET['subdir']."/"); }
if($_GET['subdir']==null&&$_GET['dir']!=null&&$chdone!=true) { $chdone = true;
